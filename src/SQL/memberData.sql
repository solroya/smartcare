...
VALUES (member_seq.NEXTVAL, 'member1001', 'password1', '노태문', 'member1001@example.com', 0, '010-1234-5678', TO_DATE('2010-01-01', 'YYYY-MM-DD'), 0, SYSTIMESTAMP, SYSTIMESTAMP);

INSERT INTO member (member_no, member_id, member_pass, member_name, member_email, member_gender, member_phone_number, member_birthday, is_social, created_at, updated_at)
VALUES (member_seq.NEXTVAL, 'member1002', 'password2', '스티븐', 'member1002@example.com', 0, '010-5678-1234', TO_DATE('1988-02-15', 'YYYY-MM-DD'), 0, SYSTIMESTAMP, SYSTIMESTAMP);
...
INSERT INTO member (member_no, member_id, member_pass, member_name, member_email, member_gender, member_phone_number, member_birthday, is_social, created_at, updated_at)
VALUES (member_seq.NEXTVAL, 'member1006', 'password6', '팀쿡', 'member1006@example.com', 1, '010-1111-2232', TO_DATE('1994-09-03', 'YYYY-MM-DD'), 0, SYSTIMESTAMP, SYSTIMESTAMP);
